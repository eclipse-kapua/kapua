...
<!-- TOC -->
* [2.0.0-M20-BUFFER-SNAPSHOT](#200-snapshot)
  * [Changes](#changes)
...
# 2.0.0-M20-BUFFER-SNAPSHOT

This report is only partial for Eclipse Kapua release 2.0.0-M20-BUFFER-SNAPSHOT, since we started to maintain it mid-release development.
