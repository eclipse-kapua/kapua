...
public class UserTagAddDialog extends EntityAddEditDialog {
    ...
    public UserTagAddDialog(GwtSession currentSession, GwtUser selectedUser) {
    ...
    public void submit() {
        ...
        GWT_USER_SERVICE.addUserTag(xsrfToken, selectedUser.getScopeId(), selectedUser.getId(), tagId, new AsyncCallback<Void>() {
    ...
    public String getInfoMessage() {
        return "Apply a tag to the user.";
    }
    ...
    public void createBody() {
        ...
        Listener<BaseEvent> comboBoxListener = new Listener<BaseEvent>() {
            ...
            public void handleEvent(BaseEvent be) {
                UserTagAddDialog.this.formPanel.fireEvent(Events.OnClick);
            }
        };
        // Tags
        ...
        tagsCombo.setToolTip("Select a tag from the list to be applied to the user.");
        ...
        GWT_TAG_SERVICE.findAll(selectedUser.getScopeId(), new AsyncCallback<List<GwtTag>>() {
