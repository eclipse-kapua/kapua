...
public class UserTabGroups extends KapuaTabItem<GwtUser> {

    private UserGroupGrid userGroupGrid;

    public UserTabGroups(GwtSession currentSession) {
        super(currentSession, "Groups", new KapuaIcon(IconSet.OBJECT_GROUP));

        userGroupGrid = new UserGroupGrid(null, currentSession, selectedEntity);
    ...
    public void setEntity(GwtUser selectedUser) {
        ...
        userGroupGrid.setSelectedUser(selectedUser);
