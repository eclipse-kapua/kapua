...
import org.eclipse.kapua.app.console.module.authorization.client.group.EntityGroupDataProvider;
import org.eclipse.kapua.app.console.module.authorization.client.group.GroupAddDialog;
import org.eclipse.kapua.app.console.module.authorization.client.group.GroupDeleteDialog;
import org.eclipse.kapua.app.console.module.authorization.client.group.GroupEditDialog;
...
import org.eclipse.kapua.app.console.module.device.shared.service.GwtDeviceGroupServiceAsync;

public class DeviceGroupDataProvider implements EntityGroupDataProvider<GwtGroup, GwtGroupQuery> {

    private static final ConsoleGroupMessages GROUP_MSGS = GWT.create(ConsoleGroupMessages.class);

    private static final GwtDeviceGroupServiceAsync GWT_DEVICE_GROUP_SERVICE = GWT.create(GwtDeviceGroupService.class);
    ...
    public RpcProxy<PagingLoadResult<GwtGroup>> getEntityGridDataProxy(final GwtGroupQuery query) {
        return new RpcProxy<PagingLoadResult<GwtGroup>>() {
            ...
            protected void load(Object loadConfig, AsyncCallback<PagingLoadResult<GwtGroup>> callback) {
                GWT_DEVICE_GROUP_SERVICE.query((PagingLoadConfig) loadConfig, query, callback);
            }
        };
    }
    ...
    public void getEntityDescriptionTabResults(GwtGroup selectedEntity, Object loadConfig, AsyncCallback<ListLoadResult<GwtGroupedNVPair>> callback) {
        GWT_DEVICE_GROUP_SERVICE.getDeviceGroupDescription(selectedEntity.getScopeId(), selectedEntity.getId(), callback);
    }
    ...
    public void handleCreateEntityGroup(EntityAddEditDialog entityAddDialog, GwtGroupCreator gwtGroupCreator) {
        ...
        GWT_DEVICE_GROUP_SERVICE.create(gwtGroupCreator, new AsyncCallback<GwtGroup>() {
    ...
    public void handleUpdateEntityGroup(EntityAddEditDialog entityEditDialog, GwtGroup selectedGroup) {
        ...
        GWT_DEVICE_GROUP_SERVICE.update(selectedGroup, new AsyncCallback<GwtGroup>() {
    ...
    public void handleDeleteEntityGroup(EntityDeleteDialog entityDeleteDialog, GwtGroup gwtGroup) {
        ...
        GWT_DEVICE_GROUP_SERVICE.delete(gwtGroup.getScopeId(), gwtGroup.getId(), new AsyncCallback<Void>() {
