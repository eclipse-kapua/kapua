...
public class GroupTabTagsDescriptor extends AbstractEntityTabDescriptor<GwtGroup, GroupTabTags, GroupView> {

    @Override
    public GroupTabTags getTabViewInstance(GroupView view, GwtSession currentSession) {
