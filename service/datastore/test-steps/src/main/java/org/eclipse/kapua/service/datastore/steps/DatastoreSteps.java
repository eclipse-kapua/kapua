...
public class DatastoreSteps extends TestBase {
    ...
    @Given("I store a message with clientId \"(.*)\" on topic \"(.*)\" with timestamp now and metrics")
    ...
    @Given("I store a message with clientId \"(.*)\" on topic \"(.*)\" with timestamp \"(.*)\" and metrics")
