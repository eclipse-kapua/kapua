...
/**
 * {@link User} {@link GroupRole} {@link KapuaEntityService} definition.
 *
 * @since 2.1.0
 */
public interface UserGroupRoleService extends KapuaEntityService<GroupRole, GroupRoleCreator> {

    /**
     * Finds the {@link GroupRole}s by scope identifier and {@link UserGroup#getId()}
     *
     * @param scopeId      The scope id in which to search.
     * @param userGroupId The {@link UserGroup} id to search.
     * @return The {@link GroupRole}s related to the {@link UserGroup#getId()}
     * @throws KapuaException
     * @since 2.1.0
     */
    GroupRoleListResult findByGroupId(KapuaId scopeId, KapuaId userGroupId) throws KapuaException;
