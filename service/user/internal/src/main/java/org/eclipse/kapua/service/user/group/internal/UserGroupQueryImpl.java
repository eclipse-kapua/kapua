...
/**
 * {@link UserGroupQuery} implementation.
 *
 * @since 2.1.0
 */
public class UserGroupQueryImpl extends AbstractKapuaNamedQuery implements UserGroupQuery {
     ...
     * @since 2.1.0
     */
    public UserGroupQueryImpl(KapuaId scopeId) {
        super(scopeId);
    }
}
