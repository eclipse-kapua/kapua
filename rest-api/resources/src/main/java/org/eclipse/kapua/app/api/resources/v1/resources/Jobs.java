...
public class Jobs extends AbstractKapuaResource {
    ...
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(schema = @Schema(implementation = JobListResult.class))
        ),
        @ApiResponse(
            responseCode = "400",
    ...
    public JobListResult simpleQuery(
            ...
            @Parameter(description = "The job name to filter results")
    ...
    @Operation(summary = "Query the Jobs")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
    ...
    public JobListResult query(
            @Parameter(description = "The ID of the Scope where to perform the operation.")
            @PathParam("scopeId") ScopeId scopeId,
            @Parameter(description = "An object to specify Query options")
    ...
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Operation(summary = "Count the Jobs")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
    ...
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Operation(summary = "Update a single Job")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
    ...
    public Job update(
            ...
            @Parameter(description = "An object containing the new properties for the Job to update")
    ...
    @DELETE
    @Path("{jobId}")
    @Operation(summary = "Delete a single Job")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "204",
    ...
    public Response deleteJob(
            ...
            @Parameter(description = "The ID of the Job on which to perform the operation")
            @PathParam("jobId") EntityId jobId,
            @Parameter(description = "Delete the Job forcibly. It can only be used by the system administrator.")
