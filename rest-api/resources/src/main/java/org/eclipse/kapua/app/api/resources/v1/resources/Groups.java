...
public class Groups extends AbstractKapuaResource {
    ...
    public GroupListResult simpleQuery(
            ...
            @Parameter(description = "The group name to filter results")
    ...
    @Operation(summary = "Query the Groups")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
            description = "The result of the query",
            content = @Content(schema = @Schema(implementation = GroupListResult.class))
        ),
        @ApiResponse(
            responseCode = "400",
            description = "An illegal argument has been passed to the operation",
    ...
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Operation(summary = "Count the Groups")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
    ...
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Operation(summary = "Create a new Groups")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
            description = "The Groups that has just been created",
            content = @Content(schema = @Schema(implementation = GroupListResult.class))
        ),
        @ApiResponse(
            responseCode = "400",
    ...
    @Path("{groupId}")
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(summary = "Get a single Group")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
    ...
    public Group find(
            @Parameter(description = "The ID of the Scope where to perform the operation.")
            @PathParam("scopeId") ScopeId scopeId,
            @Parameter(description = "The ID of the Group on which to perform the operation")
    ...
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Operation(summary = "Update a single Group")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
    ...
    @DELETE
    @Path("{groupId}")
    @Operation(summary = "Delete a single Group")
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "204",
